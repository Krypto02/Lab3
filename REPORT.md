...
- **Lab 3**: [https://github.com/Krypto02/Lab3](https://github.com/Krypto02/Lab3)

### HuggingFace Spaces

- **Lab 2**: [Space Link - To be provided]
- **Lab 3**: [https://huggingface.co/spaces/Krypto02/mlops-lab3](https://huggingface.co/spaces/Krypto02/mlops-lab3)

### Additional Deployments

- **Lab 3 API (Render)**: [https://lab3-m64w.onrender.com](https://lab3-m64w.onrender.com)
...
2. **Production Deployment**: Multi-tier architecture (HF Space → Render API)
